...
| London (eu-west-2) | {{% button href="https://s3.eu-west-2.amazonaws.com/sagemaker-workshop-cloudformation-eu-west-2/quickstart/ds_administration.yaml --region eu-west-2 --stack-name ds-administration --capabilities CAPABILITY_NAMED_IAM" icon="fas fa-play" %}} Deploy to AWS London {{% /button %}} |
